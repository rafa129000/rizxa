...
async function startjobotz() {
    const jobotz = jobotzConnect({
        ...
        browser: ['FARIZ JO V8', 'Safari','1.0.0'],
        auth: state
    })
    ...
    jobotz.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Selamat Datang Kawan Jangan Lupa Subscribe Channel De Jo Bot Dan Fariz Mods Biar Emaknya Bangga&language=id`)
...
│➳ FARIZ modz. https://youtube.com/channel/UCmfGOnP_M0ucKN8Y5Y4yBOQ
╰━ ━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ 🚫📵🚫 ▬▭▬▭▬
...
© BOT PRIBADI VIP
  `
                ...
                asa1 = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Selamat Tinggal Kawan Kalau Balik Lagi Jangan Lupa Bawa Gorengan Jangan Lupa Subscribe Channel De Jo Bot Dan Fariz Mods Biar Emaknya Bangga&language=id`)
                anunya2 =`
╭━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━╮
┃╭┈─────────────⩵꙰ཱི࿐
┃╰── ⏤͟͟͞GOOD BYE ──➤ ↶↷
